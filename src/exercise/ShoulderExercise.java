...
public class ShoulderExercise extends Exercise {    //0501 Chest와같이 Exercise종류 shoulder 추가
	...
	public void printInfo() {       		//0501 exercise의 종류를
		String skind = "none";
		switch(this.Kind) {
		case Chest:
			skind = "Chest.";
		...
		System.out.println("kind : "+ skind +", part : "+ part +", set : "+ set +", times : "+ times +", holidayset : "+ set +", times : "+ times);
	}
}
